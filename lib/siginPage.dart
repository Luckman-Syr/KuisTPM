...
import 'package:kuisku/loginPage.dart';
...
class _SiginPageState extends State<SiginPage> {
  ...
  Widget _iconLogin() {
    return Image.network(
      "https://asset.kompas.com/crops/RWEiZmzG9UqmMZ1EqIz_MBHpKOM=/11x0:855x563/750x500/data/photo/2020/04/15/5e96d81ade43f.jpg",
      width: 50.0,
      height: 50.0,
    );
  }
